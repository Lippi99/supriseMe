<template>
  <div style="padding: 30px">
    <h2 style="font-size: 40px; text-align: center; margin-bottom: 30px">
      <span style="color: rgb(255, 255, 255)">Política Privacidade</span>
    </h2>
    <p>
      <span style="color: rgb(255, 255, 255)"
        ...
        <a href="https://surpriseMe.com.br">surpriseMe</a>, e outros sites que
    ...
    <h3>
      <span style="color: rgb(255, 255, 255)">Compromisso do Usuário</span>
    </h3>
    <p>
      <span style="color: rgb(255, 255, 255)"
        >O usuário se compromete a fazer uso adequado dos conteúdos e da
        informação que o surpriseMe oferece no site e com caráter enunciativo,
    ...
    <ul>
      ...
      <li>
        <span style="color: rgb(255, 255, 255)"
          ...
          (softwares) do surpriseMe, de seus fornecedores ou terceiros, para
    ...
    <p>
      <span style="color: rgb(255, 255, 255)"
        >Esta política é efetiva a partir de&nbsp;5 December 2024 13:59</span
      >
    </p>
  </div>
</template>
...
useSeoMeta({
  ...
  description: "Política de Privacidade do site surpriseMe",
});
</script>
