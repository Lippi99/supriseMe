  ...
  messages: {
    en: {
      ...
      createPage: {
        ...
        uploadThemeImage: "Upload Theme Image",
        themeImagePreview: "Theme Image Preview",
        removeThemeImage: "Remove Theme Image",
      ...
      youtubeMusic: {
        ...
        backgroundMusicTrack: "Background Music Track",
      ...
      signInModal: {
        title: "Welcome Back",
        subtitle:
          "Sign in to your account to continue creating amazing surprises",
      ...
      auth: {
        ...
        register: {
          ...
          subtitle: "Join us to create amazing surprise pages",
    ...
    pt: {
      ...
      createPage: {
        ...
        uploadThemeImage: "Enviar Imagem do Tema",
        themeImagePreview: "Pré-visualização da Imagem do Tema",
        removeThemeImage: "Remover Imagem do Tema",
      ...
      signInModal: {
        ...
        subtitle:
          "Entre em sua conta para continuar criando surpresas incríveis",
      ...
      auth: {
        login: {
          title: "Entrar",
          subtitle: "Bem-vindo de volta! Por favor, entre em sua conta",
        ...
        register: {
          title: "Criar Conta",
          subtitle: "Junte-se a nós para criar páginas de surpresa incríveis",
