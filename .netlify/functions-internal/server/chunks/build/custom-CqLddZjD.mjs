...
import { b as useUI, k as arrow, _ as __nuxt_component_3 } from './Icon-DrNIFf4I.mjs';
import { _ as __nuxt_component_0$1, b as __nuxt_component_1 } from './Card-B89ElPpR.mjs';
import { defineComponent, toRef, computed, useSSRContext, ref, useSlots, withAsyncContext, reactive, withCtx, createVNode, toDisplayString, createTextVNode, unref, openBlock, createBlock, Fragment, renderList, createCommentVNode, mergeProps } from 'vue';
import { twMerge, twJoin } from 'tailwind-merge';
import { m as mergeConfig, a as appConfig, c as useAuth, h as useI18n, k as useRuntimeConfig } from './server.mjs';
import { ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderAttr, ssrRenderSlot, ssrRenderAttrs, ssrRenderClass } from 'vue/server-renderer';
import { _ as _export_sfc } from './_plugin-vue_export-helper-1tPrXgE0.mjs';
import { c as defu } from '../_/nitro.mjs';
import { u as usePopper, b as useClientStripe, a as useToast, c as __nuxt_component_5 } from './useClientStripe-J-UZ3wJ2.mjs';
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props, { emit: __emit }) {
    ...
    }, "$raHY5FzZzE")), __temp = await __temp, __restore(), __temp);
    ...
    const googleEmail = (_b = (_a = googleData.value) == null ? void 0 : _a.user) == null ? void 0 : _b.email;
    ...
    async function stripeBuyNotActive(websiteId, plan) {
      ...
      try {
        const { data: data2 } = await useFetch("/api/stripe/checkout", {
          method: "POST",
          headers: {
            "Content-Type": "application/json"
          },
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_UCard, { ui: {
              ...
              header: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<h1 class="text-center text-3xl"${_scopeId2}>${ssrInterpolate(_ctx.$t("myWebsites.title"))} \u{1F525}</h1>`);
                } else {
                  return [
                    createVNode("h1", { class: "text-center text-3xl" }, toDisplayString(_ctx.$t("myWebsites.title")) + " \u{1F525}", 1)
                  ];
                }
              }),
              footer: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="flex items-end justify-end"${_scopeId2}>`);
                  _push3(ssrRenderComponent(_component_UButton, {
                    onClick: ($event) => updateIsOpen(false)
                  }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`${ssrInterpolate(_ctx.$t("myWebsites.close"))}`);
                      } else {
                        return [
                          createTextVNode(toDisplayString(_ctx.$t("myWebsites.close")), 1)
                        ];
                      }
                    }),
                    _: 1
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                ...
                if (_push3) {
                  if (unref(hasData)) {
                    _push3(`<div${_scopeId2}><ul class="flex flex-col gap-8"${_scopeId2}><!--[-->`);
                    ssrRenderList((_a2 = unref(data)) == null ? void 0 : _a2.websites, (site) => {
                      _push3(`<li class="flex justify-between"${_scopeId2}>`);
                      if (site.active) {
                        _push3(`<a target="_blank" class="font-bold"${ssrRenderAttr("href", unref(config2).public.baseUrl + "/website/" + site.id)}${_scopeId2}>${ssrInterpolate(unref(config2).public.baseUrl + "/website/" + site.id)}</a>`);
                      } else {
                        _push3(`<span class="text-gray-500"${_scopeId2}>${ssrInterpolate(unref(config2).public.baseUrl + "website/" + site.id)}</span>`);
                      }
                      ...
                      if (!site.active) {
                        _push3(ssrRenderComponent(_component_UButton, {
                          ...
                          onClick: ($event) => stripeBuyNotActive(site.id, site.plan),
                          color: "red"
                        }, {
                          default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                            if (_push4) {
                              _push4(`${ssrInterpolate(_ctx.$t("myWebsites.statusInactive"))}`);
                            } else {
                              return [
                                createTextVNode(toDisplayString(_ctx.$t("myWebsites.statusInactive")), 1)
                              ];
                            }
                          }),
                          _: 2
                        ...
                        _push3(ssrRenderComponent(_component_UButton, { color: "green" }, {
                          default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                            if (_push4) {
                              _push4(`${ssrInterpolate(_ctx.$t("myWebsites.statusActive"))}`);
                            } else {
                              return [
                                createTextVNode(toDisplayString(_ctx.$t("myWebsites.statusActive")), 1)
                              ];
                            }
                          }),
                          _: 2
                    ...
                    _push3(`<div${_scopeId2}><span class="text-center"${_scopeId2}>${ssrInterpolate(_ctx.$t("myWebsites.noWebSite"))}</span></div>`);
                  }
                } else {
                  return [
                    unref(hasData) ? (openBlock(), createBlock("div", { key: 0 }, [
                      createVNode("ul", { class: "flex flex-col gap-8" }, [
                        (openBlock(true), createBlock(Fragment, null, renderList((_b2 = unref(data)) == null ? void 0 : _b2.websites, (site) => {
                          return openBlock(), createBlock("li", {
                            class: "flex justify-between",
                            key: site.id
                          }, [
                            site.active ? (openBlock(), createBlock("a", {
                              key: 0,
                              target: "_blank",
                              class: "font-bold",
                              href: unref(config2).public.baseUrl + "/website/" + site.id
                            }, toDisplayString(unref(config2).public.baseUrl + "/website/" + site.id), 9, ["href"])) : (openBlock(), createBlock("span", {
                              key: 1,
                              class: "text-gray-500"
                            }, toDisplayString(unref(config2).public.baseUrl + "website/" + site.id), 1)),
                            createVNode("div", { class: "relative" }, [
                              !site.active ? (openBlock(), createBlock(_component_UTooltip, {
                                key: 0,
                                class: "cursor-pointer absolute -right-3 -top-5",
                                text: "Voc\xEA precisa ativar o site para acessar",
                                popper: { arrow: true }
                              ...
                              !site.active ? (openBlock(), createBlock(_component_UButton, {
                                key: 1,
                                loading: unref(loadingStates)[site.id],
                                onClick: ($event) => stripeBuyNotActive(site.id, site.plan),
                                color: "red"
                                ...
                                _: 2
                              }, 1032, ["loading", "onClick"])) : (openBlock(), createBlock(_component_UButton, {
                                key: 2,
                                color: "green"
                              }, {
                                default: withCtx(() => [
                      ...
                      createVNode("span", { class: "text-center" }, toDisplayString(_ctx.$t("myWebsites.noWebSite")), 1)
                    ]))
                  ];
                }
              }),
              ...
              createVNode(_component_UCard, { ui: {
                ...
                default: withCtx(() => {
                  ...
                  return [
                    unref(hasData) ? (openBlock(), createBlock("div", { key: 0 }, [
                      createVNode("ul", { class: "flex flex-col gap-8" }, [
                        (openBlock(true), createBlock(Fragment, null, renderList((_a2 = unref(data)) == null ? void 0 : _a2.websites, (site) => {
                          return openBlock(), createBlock("li", {
                            class: "flex justify-between",
                            key: site.id
                          }, [
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/MyWebsites.vue");
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><header class="h-28"><div class="flex h-full justify-between items-center px-16 gap-4">`);
        ...
        _push(ssrRenderComponent(_component_UButton, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              return [
                createTextVNode(toDisplayString(_ctx.$t("header.myWebsites")), 1)
              ];
            }
          }),
          _: 1
      ...
      _push(`</button><button aria-label="lang" type="button" class="cursor-pointer">`);
      _push(ssrRenderComponent(_component_UIcon, {
        "aria-label": "us",
        class: "w-10 h-10",
        name: "i-flag:us-4x3"
      ...
      _push(ssrRenderComponent(_component_MyWebsites, {
        isOpen: isOpen.value,
