import { hasInjectionContext, inject, version, unref, ref, watchEffect, watch, getCurrentInstance, onMounted, isRef, onScopeDispose, h, toRef, defineAsyncComponent, defineComponent, readonly, provide, shallowReactive, Suspense, nextTick, Fragment, Transition, useSSRContext, computed, createApp, effectScope, reactive, getCurrentScope, shallowRef, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, mergeProps, isReadonly, toRaw, Text, isShallow, isReactive } from 'vue';
import { $ as $fetch$1, F as baseURL, i as createError$1, G as defuFn, H as klona, c as defu, I as sanitizeStatusCode, J as createDefu, K as getContext, L as createHooks, M as appendHeader, N as getRequestHeaders, O as getHeader, P as toRouteMatcher, Q as createRouter$1, R as parse$1, S as getRequestHeader, T as destr, U as isEqual$1, w as setCookie, V as getCookie, W as deleteCookie } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "create___en",
    path: "/en/create",
    component: () => import('./create-Bjxhscf-.mjs')
  },
  {
    name: "create___pt",
    path: "/create",
  ...
  },
  {
    name: "index___en",
    path: "/en",
    component: () => import('./index-Bq5eA4f8.mjs')
  },
  {
    name: "index___pt",
    path: "/",
  ...
  },
  {
    ...
    component: () => import('./privacy-policy-DTmHMowS.mjs')
  },
  {
  ...
  {
    name: "success-id___en",
    path: "/en/success/:id()",
    component: () => import('./_id_--lvU_3Nj.mjs')
  },
  {
    name: "success-id___pt",
    path: "/success/:id()",
    component: () => import('./_id_--lvU_3Nj.mjs')
  },
  {
    name: "term-services___en",
    path: "/en/term-services",
    component: () => import('./term-services-C8VaRbHV.mjs')
  },
  {
    name: "term-services___pt",
    path: "/term-services",
    component: () => import('./term-services-C8VaRbHV.mjs')
  },
  {
    name: "website-id___en",
    path: "/en/website/:id()",
    component: () => import('./_id_-BnMnMEyT.mjs')
  },
  {
    name: "website-id___pt",
    path: "/website/:id()",
    component: () => import('./_id_-BnMnMEyT.mjs')
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./index-DZrM-LkX.mjs').then(function(n) {
  return n.i;
...
const _refreshHandler = new DefaultRefreshHandler({ "enablePeriodically": 36e5, "enableOnWindowFocus": false });
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CtQGUuo2.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-7SBelNzr.mjs'));
...
export { fetchDefaults as A, useRequestFetch as B, useRequestEvent as C, withLeadingSlash as D, joinURL as E, encodeParam as F, encodePath as G, parseQuery as H, nuxtLinkDefaults as I, resolveRouteObject as J, navigateTo as K, LayoutMetaSymbol as L, withTrailingSlash as M, withoutTrailingSlash as N, PageRouteSymbol as P, _wrapIf as _, appConfig as a, useNuxtApp as b, useAuth as c, useSeoMeta as d, entry$1 as default, useRoute as e, useRouter as f, get as g, useI18n as h, injectHead$1 as i, useServerSeoMeta as j, useRuntimeConfig as k, looseToNumber as l, mergeConfig as m, injectHead as n, omit as o, useScript as p, parseURL as q, resolveUnrefHeadInput$1 as r, appLayoutTransition as s, useAppConfig as t, useHead as u, asyncDataDefaults as v, createError as w, useState as x, useLocalePath as y, hasProtocol as z };
